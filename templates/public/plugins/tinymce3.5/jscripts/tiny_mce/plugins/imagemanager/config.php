...
$mcImageManagerConfig['filesystem.rootpath'] = realpath(dirname(__FILE__) . '/../../../../../../../../images'); // absolute or relative from this script path, required.
...
// Upload options
$mcImageManagerConfig['upload.maxsize'] = ini_get('upload_max_filesize');
