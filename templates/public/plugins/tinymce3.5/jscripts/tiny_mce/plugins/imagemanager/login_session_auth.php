...
$msg = "";
$username = "admin";
$password = "bionaturalmed"; // Change the password to something suitable
...
<div class="container">
	<form action="login_session_auth.php" method="post" name="forma" id="forma">
		<input type="hidden" name="return_url" value="<?php echo isset(
		$_REQUEST['return_url']) ? htmlentities($_REQUEST['return_url']) : ""; ?>" />
		...
		<fieldset>
			...
			<div>
				...
				<input type="text" name="login" class="text" value="admin" />
			</div>

			<div>
				<label>Password:</label>
				<input type="password" name="password" class="text" value="bionaturalmed" />
			</div>
