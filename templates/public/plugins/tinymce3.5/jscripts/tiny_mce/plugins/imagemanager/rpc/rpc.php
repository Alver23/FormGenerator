...
if (file_exists("../install"))
	die(
			'{"result":null,"id":null,"error":{"errstr":"You need to run the installer or rename/remove the \\"install\\" directory.","errfile":"","errline":null,"errcontext":"","level":"FATAL"}}');
...
if ($type == "")
	die(
			'{"result":null,"id":null,"error":{"errstr":"No type set.","errfile":"","errline":null,"errcontext":"","level":"FATAL"}}');
...
if ($man->isAuthenticated()) {
	$man
			->dispatchEvent("onBeforeRPC",
					array($input['method'], $input['params'][0]));
	...
	die(
			'{"result":{"login_url":"'
					. addslashes($config["authenticator.login_page"])
					. '"},"id":null,"error":{"errstr":"Access denied by authenicator.","errfile":"","errline":null,"errcontext":"","level":"AUTH"}}');
?>