...
$this->javascripts->add('public/js/project/proveedores.js');?>
<div class='row'> 
<div class='col-lg-12'> 
<section class='panel'> 
...
<table class='table table-bordered table-striped' id='table'> 
	 <thead> 
	   <tr> 
	 	 <th class='essential'>idproveedores</th> 
...
<div class="row" id="idForm" style="display:none;"><div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><section class="panel"><div class="panel-body" id="divform"><form name="proveedores" id="proveedores" action="" method="POST" >
	<input type="hidden" name="idproveedores" id="idproveedores" value=""  /><br />
<div class='row'> 
	<div class='col-md-12'> 
