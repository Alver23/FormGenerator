...
$loader = new sfTemplateLoaderFilesystem(FRONTEND_TEMPLATES . '/%name%.php');
...
$templateEngineHandler = new TemplateEngineHandler($engine);
$seourl->setTemplatingEngine($templateEngineHandler);
$toInclude = $seourl->manageRedirects();
