...
class content_negotiation {
	...
	static public function mime_all_negotiation(array $app_types = array(),
			$aggregate_vals = false) {
		$app_types = self::app_array_old_to_new($app_types);
		return self::app_array_new_to_old(
				conNeg::mimeAll($app_types, $aggregate_vals));
	}
	...
	static public function charset_all_negotiation(array $app_types = array(),
		...
		$app_types = self::app_array_old_to_new($app_types);
		return self::app_array_new_to_old(
				conNeg::charAll($app_types, $aggregate_vals));
	}

	// return only the preferred encoding-type
	static public function encoding_best_negotiation(
			array $app_types = array(), $aggregate_vals = false) {
		$app_types = self::app_array_old_to_new($app_types);
	...
	static public function encoding_all_negotiation(array $app_types = array(),
		...
		$app_types = self::app_array_old_to_new($app_types);
		return self::app_array_new_to_old(
				conNeg::encAll($app_types, $aggregate_vals));
	}

	// return only the preferred language
	static public function language_best_negotiation(
			array $app_types = array(), $aggregate_vals = false) {
		$app_types = self::app_array_old_to_new($app_types);
	...
	static public function language_all_negotiation(array $app_types = array(),
		...
		$app_types = self::app_array_old_to_new($app_types);
		return self::app_array_new_to_old(
				conNeg::langAll($app_types, $aggregate_vals));
	}
